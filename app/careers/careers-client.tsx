...
const ROLES = [
  ...
  },
  {
    ...
    desc: "Build Jobingen's AI-powered brand automation engine — a daily pipeline that generates on-brand social posts (copy + designed images) fully automatically. You ship the system, not just features.",
    badge: "NEW",
  },
  {
