  ...
  return (
    <section style={{ background:"#f7f7fb", padding:"80px 0", overflow:"hidden" }}>
      ...
      <div style={{ textAlign:"center", paddingTop:32, paddingBottom:48 }}>
        <a href="/bootcamp" style={{ display:"inline-flex", alignItems:"center", gap:8, background:"#1d3a8f", color:"white", borderRadius:14, padding:"13px 28px", fontSize:14, fontWeight:700, textDecoration:"none", boxShadow:"0 4px 20px rgba(29,58,143,0.3)", transition:"transform .15s, box-shadow .15s" }}
