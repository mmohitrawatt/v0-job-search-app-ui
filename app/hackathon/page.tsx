...
// ─── QR Placeholder ──────────────────────────────────────────────────────────
// Replace the src with your actual QR code image path, e.g. "/qr-jobingen.png"
...
const INIT: FormData = {
  name: "", email: "", phone: "", college: "", team_name: "", upi_transaction_id: "",
}
    ...
    <div style={{
      ...
      <div style={{ maxWidth: 480, width: "100%", textAlign: "center" }} className="fade-up">
        ...
        <p style={{ fontSize: 15, color: "var(--ink2)", lineHeight: 1.72, margin: "0 0 32px", maxWidth: 380, marginLeft: "auto", marginRight: "auto" }}>
          Your hackathon registration has been submitted successfully. We will verify your payment and send confirmation to your email.
        </p>
        ...
        <div style={{
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            {[
              ...
              { icon: "💬", text: "WhatsApp group link shared before the hackathon" },
              { icon: "🏆", text: "Hackathon problem statement shared on Day 1" },
            ].map((s, i) => (
      ...
      <div style={{
        ...
        <div>
          ...
          <div style={{ fontSize: 24, fontWeight: 900, color: "white", lineHeight: 1.1 }}>
            ₹199 <span style={{ fontSize: 13, fontWeight: 500, opacity: .7 }}>only</span>
          </div>
        </div>
      </div>
      ...
      <div style={{ padding: "24px" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12, marginBottom: 24 }}>
          {[
            ...
            { n: "2", text: "Pay ₹199 using any UPI app" },
        ...
        <div style={{
          ...
          {/* QR Image — replace src with your actual QR image */}
          <div style={{
                ...
                if (parent) {
                  parent.innerHTML = `
                    <div style="display:flex;flex-direction:column;align-items:center;gap:8px;color:#8a8aa8;font-size:12px;text-align:center">
                      ...
                      <span>Add QR code<br/>image at<br/>/public/qr-jobingen.png</span>
                    </div>
                  `
                }
              }}
          ...
          <div style={{ textAlign: "center" }}>
            ...
            >
              <span style={{ fontSize: 15, fontWeight: 800, color: "var(--ind)", letterSpacing: ".01em" }}>
                {UPI_ID}
              </span>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8, justifyContent: "center", flexWrap: "wrap" }}>
          ...
          {["Paytm", "PhonePe", "Google Pay", "BHIM"].map((app) => (
            <span
              key={app}
              style={{
                fontSize: 11, fontWeight: 700, color: "var(--ind)",
                padding: "3px 8px", borderRadius: 6, background: "var(--ind-l)",
              }}
            >
              {app}
            </span>
        ...
        <div style={{
          ...
          Scan the QR code or send payment using any UPI app such as Paytm, PhonePe, Google Pay, or your banking app.
          Then enter your transaction ID in the form below.
        </div>
      </div>
    </div>
  )
        ...
        >
          ...
          <div style={{ marginBottom: 40, maxWidth: 600 }}>
            ...
            <h1 style={{
              ...
              Register for the<br />
              <span className="shimmer">AI Hackathon</span>
            </h1>
            <p style={{ fontSize: 15, color: "var(--ink2)", lineHeight: 1.7, maxWidth: 480 }}>
              Sunday, 15 March 2026 · Online · ₹199 registration fee · Build real AI in 1 day and compete for prizes.
            </p>
          </div>
          ...
          >
              ...
              >
                ...
                <div className="form-2col" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
                  <Field label="Full Name *" error={errors.name}>
                    <input
                      className={`h-field${errors.name ? " error" : ""}`}
                ...
                <Field label="Team Name *" error={errors.team_name}>
                  <input
                    className={`h-field${errors.team_name ? " error" : ""}`}
                ...
                <div>
                  ...
                  <Field label="UPI Transaction ID *" error={errors.upi_transaction_id}>
                    <input
                      className={`h-field${errors.upi_transaction_id ? " error" : ""}`}
                ...
                <button
                  ...
                  disabled={loading}
                  style={{
                    fontSize: 15, fontWeight: 900, padding: "15px 28px",
                    borderRadius: 16, width: "100%", gap: 10,
                  }}
                >
                  {loading
                    ? <><Spinner /> Submitting registration...</>
                    : <>Submit Registration — ₹199 paid
            ...
            <div className="sticky-col" style={{ position: "sticky", top: 76, display: "flex", flexDirection: "column", gap: 16 }}>
              ...
              <div style={{
                borderRadius: 20, border: "1.5px solid var(--border)",
                boxShadow: "var(--shadow-sm)", overflow: "hidden", background: "white",
              }}>
                <div style={{
                  background: "linear-gradient(135deg, #5b21b6, #7c3aed)",
                  padding: "16px 20px",
                }}>
                  <div style={{ fontSize: 11, fontWeight: 800, color: "rgba(255,255,255,0.6)", textTransform: "uppercase", letterSpacing: ".07em" }}>
                    Prizes
                  </div>
                  <div style={{ fontSize: 20, fontWeight: 900, color: "white", marginTop: 4 }}>₹50,000+ pool</div>
                </div>
                <div style={{ padding: "16px 20px", display: "flex", flexDirection: "column", gap: 10 }}>
                  {[
                    { place: "1st", prize: "₹25,000 + Internship", icon: "🥇" },
                    { place: "2nd", prize: "₹15,000 + Swag kit",   icon: "🥈" },
                    { place: "3rd", prize: "₹10,000 + Certificate", icon: "🥉" },
                  ].map((p) => (
                    <div key={p.place} style={{ display: "flex", alignItems: "center", gap: 12 }}>
                      <span style={{ fontSize: 18 }}>{p.icon}</span>
                      <div>
                        <div style={{ fontSize: 13, fontWeight: 800, color: "var(--ink)" }}>{p.prize}</div>
                        <div style={{ fontSize: 11, color: "var(--ink3)" }}>{p.place} Place</div>
                      </div>
                    </div>
                  ))}
                </div>
