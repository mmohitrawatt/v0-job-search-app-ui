...
const CSS = `
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .shimmer {
    background: linear-gradient(90deg, #7c3aed 0%, #4f46e5 28%, #a78bfa 48%, #4f46e5 68%, #7c3aed 100%);
...
const INIT: FormData = {
  name: "", email: "", phone: "", college: "", upi_transaction_id: "",
}
    ...
    <div style={{
      ...
      <div style={{ padding: "24px" }}>
        ...
        <div style={{
          ...
          Then enter your transaction ID in the form.
        </div>
      </div>
    </div>
  )
        ...
        >
          ...
          <div style={{ marginBottom: 40, maxWidth: 600 }}>
            ...
            <p style={{ fontSize: 15, color: "var(--ink2)", lineHeight: 1.7, maxWidth: 480 }}>
              From call stack to backtracking mastery — live session in C++ · Only ₹29 · Register below.
            </p>
          </div>
              ...
              <div style={{
                ...
                <div style={{ padding: "16px 20px", display: "flex", flexDirection: "column", gap: 10 }}>
                  {[
                    ...
                    { icon: "🔄", text: "Backtracking Mastery" },
                    { icon: "⚡", text: "Subsets, Permutations, N-Queens" },
